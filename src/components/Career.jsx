    ...
    const openings = [
      {
        ...
        abt: (
          <p>
            ...
            designers who care deeply about helping people learn from their
            data. Our process starts with defining a vision in collaboration
            with product and engineering. Then we research, refine and remove
            (less is more) until we've landed on something that truly helps our
            customers. This role will have a strategic focus; however, you'll
            get broad exposure to the product and pair with other team leads to
        ...
        responsibilities: (
          <div>
            ...
            <p>
              ...
              collaboration with other designers, product managers, and
              engineers. Partner with product and design leadership to integrate
              your work into the overall vision of the product. Design user
              interfaces, user flows, and prototypes that bring clarity to
              complex problems. Participate in user research to better
              understand user needs. Mentor other designers and guide them on
              their work. Lead meetings and facilitate team activities
            ...
            <p>
              ...
              (e.g., interaction design, visual design, prototyping). Experience
              designing business and/or developer-focused products. Ability to
              lead large projects and manage the design process for your work.
              Excellent communication and presentation skills. Bonus Points For
            </p>
          </div>
        ),
      },
